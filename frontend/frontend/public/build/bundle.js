...
var app = (function () {
    ...
    const _Buffer$1 = typeof Buffer === 'function' ? Buffer : null;
    /** @ignore */
    const useNativeEncoders = typeof TextDecoder === 'function' && typeof TextEncoder === 'function';
    /** @ignore */
    const decodeUtf8 = ((TextDecoder) => {
        if (useNativeEncoders || !_Buffer$1) {
            const decoder = new TextDecoder('utf-8');
            return (buffer) => decoder.decode(buffer);
        }
        return (input) => {
            const { buffer, byteOffset, length } = toUint8Array(input);
            return _Buffer$1.from(buffer, byteOffset, length).toString();
        };
    })(typeof TextDecoder !== 'undefined' ? TextDecoder : TextDecoder$1);
    /** @ignore */
    const encodeUtf8 = ((TextEncoder) => {
        ...
        return (input = '') => toUint8Array(_Buffer$1.from(input, 'utf8'));
    })(typeof TextEncoder !== 'undefined' ? TextEncoder : TextEncoder$1);
    ...
    (function (org) {
        (function (apache) {
            (function (arrow) {
                (function (flatbuf) {
                    flatbuf.Schema = org$2.apache.arrow.flatbuf.Schema;
                })(arrow.flatbuf || (arrow.flatbuf = {}));
            })(apache.arrow || (apache.arrow = {}));
        })(org.apache || (org.apache = {}));
    })(org$1 || (org$1 = {}));
            ...
            (function (arrow) {
                (function (flatbuf) {
                    class RecordBatch {
                        ...
                        buffers(index, obj) {
                            let offset = this.bb.__offset(this.bb_pos, 8);
                            return offset ? (obj || new org$2.apache.arrow.flatbuf.Buffer).__init(this.bb.__vector(this.bb_pos + offset) + index * 16, this.bb) : null;
                        }
                        /**
                         * @returns number
                         */
            ...
            (function (arrow) {
                (function (flatbuf) {
                    class Message {
                        ...
                        version() {
                            let offset = this.bb.__offset(this.bb_pos, 4);
                            return offset ? /**  */ (this.bb.readInt16(this.bb_pos + offset)) : org$2.apache.arrow.flatbuf.MetadataVersion.V1;
                        }
                        /**
                        ...
                        customMetadata(index, obj) {
                            let offset = this.bb.__offset(this.bb_pos, 12);
                            return offset ? (obj || new org$2.apache.arrow.flatbuf.KeyValue).__init(this.bb.__indirect(this.bb.__vector(this.bb_pos + offset) + index * 4), this.bb) : null;
                        }
                        /**
                         * @returns number
                         */
                        ...
                        static addVersion(builder, version) {
                            builder.addFieldInt16(0, version, org$2.apache.arrow.flatbuf.MetadataVersion.V1);
                        }
                        /**
                         * @param flatbuffers.Builder builder
    ...
    // Licensed to the Apache Software Foundation (ASF) under one
    org$2.apache.arrow.flatbuf.Type;
    var DateUnit = org$2.apache.arrow.flatbuf.DateUnit;
    var TimeUnit = org$2.apache.arrow.flatbuf.TimeUnit;
    var Precision = org$2.apache.arrow.flatbuf.Precision;
    var UnionMode = org$2.apache.arrow.flatbuf.UnionMode;
    var IntervalUnit = org$2.apache.arrow.flatbuf.IntervalUnit;
    var MessageHeader = org$1.apache.arrow.flatbuf.MessageHeader;
    var MetadataVersion = org$2.apache.arrow.flatbuf.MetadataVersion;
    /**
    ...
    function truncateBitmap(offset, length, bitmap) {
        ...
        if (offset > 0 || bitmap.byteLength < alignedSize) {
            ...
            bytes.set(offset % 8 === 0 ? bitmap.subarray(offset >> 3) :
                ...
                packBools(iterateBits(bitmap, offset, length, null, getBool$1)).subarray(0, alignedSize));
            return bytes;
        }
        return bitmap;
    }
    ...
    function inferDType(type) {
        switch (type.typeId) {
            case Type$1.Null: return Type$1.Null;
            case Type$1.Int:
                const { bitWidth, isSigned } = type;
                switch (bitWidth) {
                    case 8: return isSigned ? Type$1.Int8 : Type$1.Uint8;
                    case 16: return isSigned ? Type$1.Int16 : Type$1.Uint16;
                    case 32: return isSigned ? Type$1.Int32 : Type$1.Uint32;
                    case 64: return isSigned ? Type$1.Int64 : Type$1.Uint64;
                }
                return Type$1.Int;
            case Type$1.Float:
                switch (type.precision) {
                    case Precision.HALF: return Type$1.Float16;
                    case Precision.SINGLE: return Type$1.Float32;
                    case Precision.DOUBLE: return Type$1.Float64;
                }
                return Type$1.Float;
            case Type$1.Binary: return Type$1.Binary;
            case Type$1.Utf8: return Type$1.Utf8;
            case Type$1.Bool: return Type$1.Bool;
            case Type$1.Decimal: return Type$1.Decimal;
            case Type$1.Time:
                switch (type.unit) {
                    case TimeUnit.SECOND: return Type$1.TimeSecond;
                    case TimeUnit.MILLISECOND: return Type$1.TimeMillisecond;
                    case TimeUnit.MICROSECOND: return Type$1.TimeMicrosecond;
                    case TimeUnit.NANOSECOND: return Type$1.TimeNanosecond;
                }
                return Type$1.Time;
            case Type$1.Timestamp:
                switch (type.unit) {
                    case TimeUnit.SECOND: return Type$1.TimestampSecond;
                    case TimeUnit.MILLISECOND: return Type$1.TimestampMillisecond;
                    case TimeUnit.MICROSECOND: return Type$1.TimestampMicrosecond;
                    case TimeUnit.NANOSECOND: return Type$1.TimestampNanosecond;
                }
                return Type$1.Timestamp;
            case Type$1.Date:
                switch (type.unit) {
                    case DateUnit.DAY: return Type$1.DateDay;
                    case DateUnit.MILLISECOND: return Type$1.DateMillisecond;
                }
                return Type$1.Date;
            case Type$1.Interval:
                switch (type.unit) {
                    case IntervalUnit.DAY_TIME: return Type$1.IntervalDayTime;
                    case IntervalUnit.YEAR_MONTH: return Type$1.IntervalYearMonth;
                }
            ...
            case Type$1.Union:
                switch (type.mode) {
                    case UnionMode.Dense: return Type$1.DenseUnion;
                    case UnionMode.Sparse: return Type$1.SparseUnion;
                }
                return Type$1.Union;
            case Type$1.FixedSizeBinary: return Type$1.FixedSizeBinary;
            case Type$1.FixedSizeList: return Type$1.FixedSizeList;
            case Type$1.Dictionary: return Type$1.Dictionary;
        }
    ...
    function compareList(type, other) {
        return (type === other) || (compareConstructor(type, other) &&
            ...
            instance$b.compareFields(type.children, other.children));
    }
    ...
    function compareDictionary(type, other) {
        return (type === other) || (compareConstructor(type, other) &&
            ...
            instance$b.visit(type.indices, other.indices) &&
            instance$b.visit(type.dictionary, other.dictionary));
    }
    ...
    /** @ignore */
    const instance$b = new TypeComparator();
     ...
     */
    class DataType {
        /** @nocollapse */ static isNull(x) { return x && x.typeId === Type$1.Null; }
        /** @nocollapse */ static isInt(x) { return x && x.typeId === Type$1.Int; }
        /** @nocollapse */ static isFloat(x) { return x && x.typeId === Type$1.Float; }
        /** @nocollapse */ static isBinary(x) { return x && x.typeId === Type$1.Binary; }
        /** @nocollapse */ static isUtf8(x) { return x && x.typeId === Type$1.Utf8; }
        /** @nocollapse */ static isBool(x) { return x && x.typeId === Type$1.Bool; }
        /** @nocollapse */ static isDecimal(x) { return x && x.typeId === Type$1.Decimal; }
        /** @nocollapse */ static isDate(x) { return x && x.typeId === Type$1.Date; }
        /** @nocollapse */ static isTime(x) { return x && x.typeId === Type$1.Time; }
        /** @nocollapse */ static isTimestamp(x) { return x && x.typeId === Type$1.Timestamp; }
        /** @nocollapse */ static isInterval(x) { return x && x.typeId === Type$1.Interval; }
        /** @nocollapse */ static isList(x) { return x && x.typeId === Type$1.List; }
        /** @nocollapse */ static isStruct(x) { return x && x.typeId === Type$1.Struct; }
        /** @nocollapse */ static isUnion(x) { return x && x.typeId === Type$1.Union; }
        /** @nocollapse */ static isFixedSizeBinary(x) { return x && x.typeId === Type$1.FixedSizeBinary; }
        /** @nocollapse */ static isFixedSizeList(x) { return x && x.typeId === Type$1.FixedSizeList; }
        /** @nocollapse */ static isMap(x) { return x && x.typeId === Type$1.Map; }
        /** @nocollapse */ static isDictionary(x) { return x && x.typeId === Type$1.Dictionary; }
        get typeId() { return Type$1.NONE; }
        compareTo(other) {
            return instance$b.visit(this, other);
        }
    }
    ...
    class Null$1 extends DataType {
        ...
        get typeId() { return Type$1.Null; }
    }
    Null$1[Symbol.toStringTag] = ((proto) => {
    ...
    class Float extends DataType {
        ...
        get typeId() { return Type$1.Float; }
        get ArrayType() {
    ...
    class Binary$1 extends DataType {
        ...
        get typeId() { return Type$1.Binary; }
        toString() { return `Binary`; }
    }
    Binary$1[Symbol.toStringTag] = ((proto) => {
    ...
    class Utf8$1 extends DataType {
        ...
        get typeId() { return Type$1.Utf8; }
        toString() { return `Utf8`; }
    }
    Utf8$1[Symbol.toStringTag] = ((proto) => {
        proto.ArrayType = Uint8Array;
    ...
    class Bool$1 extends DataType {
        ...
        get typeId() { return Type$1.Bool; }
        toString() { return `Bool`; }
    }
    Bool$1[Symbol.toStringTag] = ((proto) => {
        proto.ArrayType = Uint8Array;
    ...
    class Decimal$1 extends DataType {
        ...
        get typeId() { return Type$1.Decimal; }
        toString() { return `Decimal[${this.precision}e${this.scale > 0 ? `+` : ``}${this.scale}]`; }
    }
    Decimal$1[Symbol.toStringTag] = ((proto) => {
        proto.scale = null;
        proto.precision = null;
    ...
    class Timestamp_ extends DataType {
        ...
        get typeId() { return Type$1.Timestamp; }
    ...
    class Interval_ extends DataType {
        ...
        get typeId() { return Type$1.Interval; }
    ...
    class List$1 extends DataType {
        ...
        get typeId() { return Type$1.List; }
        toString() { return `List<${this.valueType}>`; }
        get valueType() { return this.children[0].type; }
        get valueField() { return this.children[0]; }
        get ArrayType() { return this.valueType.ArrayType; }
    }
    List$1[Symbol.toStringTag] = ((proto) => {
        proto.children = null;
        return proto[Symbol.toStringTag] = 'List';
    })(List$1.prototype);
    /** @ignore */
    class Struct$1 extends DataType {
    ...
    Struct$1[Symbol.toStringTag] = ((proto) => {
        proto.children = null;
    ...
    class Union_ extends DataType {
        ...
        get typeId() { return Type$1.Union; }
        toString() {
    ...
    FixedSizeBinary$1[Symbol.toStringTag] = ((proto) => {
    ...
    class FixedSizeList$1 extends DataType {
        ...
        get typeId() { return Type$1.FixedSizeList; }
        get valueType() { return this.children[0].type; }
        get valueField() { return this.children[0]; }
        get ArrayType() { return this.valueType.ArrayType; }
        toString() { return `FixedSizeList[${this.listSize}]<${this.valueType}>`; }
    }
    FixedSizeList$1[Symbol.toStringTag] = ((proto) => {
        proto.children = null;
        proto.listSize = null;
        return proto[Symbol.toStringTag] = 'FixedSizeList';
    })(FixedSizeList$1.prototype);
    /** @ignore */
    class Map_$1 extends DataType {
    ...
    Map_$1[Symbol.toStringTag] = ((proto) => {
        proto.children = null;
    ...
    function strideForType(type) {
        let t = type;
        switch (type.typeId) {
            case Type$1.Decimal: return 4;
            case Type$1.Timestamp: return 2;
            case Type$1.Date: return 1 + t.unit;
            case Type$1.Interval: return 1 + t.unit;
            case Type$1.Int: return 1 + +(t.bitWidth > 32);
            case Type$1.Time: return 1 + +(t.bitWidth > 32);
            case Type$1.FixedSizeList: return t.listSize;
            case Type$1.FixedSizeBinary: return t.byteWidth;
            default: return 1;
        }
    }
    ...
    class Data {
        ...
        static new(type, offset, length, nullCount, buffers, childData, dictionary) {
            ...
            switch (type.typeId) {
                case Type$1.Null: return Data.Null(type, offset, length);
                case Type$1.Int: return Data.Int(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Dictionary: return Data.Dictionary(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || [], dictionary);
                case Type$1.Float: return Data.Float(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Bool: return Data.Bool(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Decimal: return Data.Decimal(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Date: return Data.Date(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Time: return Data.Time(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Timestamp: return Data.Timestamp(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Interval: return Data.Interval(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.FixedSizeBinary: return Data.FixedSizeBinary(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.DATA] || []);
                case Type$1.Binary: return Data.Binary(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.OFFSET] || [], buffers[BufferType.DATA] || []);
                case Type$1.Utf8: return Data.Utf8(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.OFFSET] || [], buffers[BufferType.DATA] || []);
                case Type$1.List: return Data.List(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.OFFSET] || [], (childData || [])[0]);
                case Type$1.FixedSizeList: return Data.FixedSizeList(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], (childData || [])[0]);
                case Type$1.Struct: return Data.Struct(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], childData || []);
                case Type$1.Map: return Data.Map(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.OFFSET] || [], (childData || [])[0]);
                case Type$1.Union: return Data.Union(type, offset, length, nullCount || 0, buffers[BufferType.VALIDITY], buffers[BufferType.TYPE] || [], buffers[BufferType.OFFSET] || childData, childData);
            }
    ...
    function throughIterable(options) {
        ...
        return function* (source) {
            let numChunks = 0;
            let builder = Builder$2.new(options);
    ...
    class Schema {
        ...
        compareTo(other) {
            return instance$b.compareSchemas(this, other);
        }
        select(...columnNames) {
    ...
    class Field {
        ...
        compareTo(other) {
            return instance$b.compareField(this, other);
        }
        clone(...args) {
            let [name, type, nullable, metadata] = args;
    ...
    class ListBuilder extends VariableWidthBuilder {
        ...
        addChild(child, name = '0') {
            ...
            this.type = new List$1(new Field(name, child.type, true));
    ...
    class FixedSizeListBuilder extends Builder$2 {
        ...
        addChild(child, name = '0') {
            ...
            this.type = new FixedSizeList$1(this.type.listSize, new Field(name, child.type, true));
            return childIndex;
        }
        clear() {
            this._run.clear();
    ...
    class MapBuilder extends VariableWidthBuilder {
        ...
        addChild(child, name = `${this.numChildren}`) {
            ...
            this.children[this.numChildren] = child;
            this.type = new Map_$1(new Field(name, child.type, true), this.type.keysSorted);
            return this.numChildren - 1;
        }
        _flushPending(pending) {
            const offsets = this._offsets;
    ...
    class StructBuilder extends Builder$2 {
        addChild(child, name = `${this.numChildren}`) {
            const childIndex = this.children.push(child);
            this.type = new Struct$1([...this.type.children, new Field(name, child.type, true)]);
            return childIndex;
        }
    }
...
or supply a \`valueToChildTypeId\` function as part of the UnionBuilder constructor options.`);
    ...
    /** @ignore */
    const instance$a = new SetVisitor();
    ...
    /** @ignore */
    const instance$9 = new GetBuilderCtor();
    ...
    function newBuilder(options) {
        ...
        const builder = new (instance$9.getVisitFn(type)())(options);
        if (type.children && type.children.length > 0) {
    ...
    Object.keys(Type$1)
        .map((T) => Type$1[T])
        .filter((T) => typeof T === 'number' && T !== Type$1.NONE)
        .forEach((typeId) => {
        const BuilderCtor = instance$9.visit(typeId);
        BuilderCtor.prototype._setValue = instance$a.getVisitFn(typeId);
    });
    Utf8Builder.prototype._setValue = instance$a.visitBinary;
            ...
            (function (arrow) {
                (function (flatbuf) {
                    class Footer {
                        ...
                        schema(obj) {
                            let offset = this.bb.__offset(this.bb_pos, 6);
                            return offset ? (obj || new org$2.apache.arrow.flatbuf.Schema).__init(this.bb.__indirect(this.bb_pos + offset), this.bb) : null;
                        }
                        /**
                         * @param number index
    ...
    var _Block = org.apache.arrow.flatbuf.Block;
    var _Footer = org.apache.arrow.flatbuf.Footer;
    /** @ignore */
    class Footer_ {
    ...
    var Null = org$2.apache.arrow.flatbuf.Null;
    var Int = org$2.apache.arrow.flatbuf.Int;
    var FloatingPoint = org$2.apache.arrow.flatbuf.FloatingPoint;
    var Binary = org$2.apache.arrow.flatbuf.Binary;
    var Bool = org$2.apache.arrow.flatbuf.Bool;
    var Utf8 = org$2.apache.arrow.flatbuf.Utf8;
    var Decimal = org$2.apache.arrow.flatbuf.Decimal;
    var Date$1 = org$2.apache.arrow.flatbuf.Date;
    var Time = org$2.apache.arrow.flatbuf.Time;
    var Timestamp = org$2.apache.arrow.flatbuf.Timestamp;
    var Interval = org$2.apache.arrow.flatbuf.Interval;
    var List = org$2.apache.arrow.flatbuf.List;
    var Struct = org$2.apache.arrow.flatbuf.Struct_;
    var Union = org$2.apache.arrow.flatbuf.Union;
    var DictionaryEncoding = org$2.apache.arrow.flatbuf.DictionaryEncoding;
    var FixedSizeBinary = org$2.apache.arrow.flatbuf.FixedSizeBinary;
    var FixedSizeList = org$2.apache.arrow.flatbuf.FixedSizeList;
    var Map_ = org$2.apache.arrow.flatbuf.Map;
    /** @ignore */
    ...
    /** @ignore */
    const instance$8 = new TypeAssembler();
    ...
    function typeFromJSON(f, children) {
        ...
        switch (typeId) {
            case 'NONE': return new Null$1();
            case 'null': return new Null$1();
            case 'binary': return new Binary$1();
            case 'utf8': return new Utf8$1();
            case 'bool': return new Bool$1();
            case 'list': return new List$1((children || [])[0]);
            case 'struct': return new Struct$1(children || []);
            case 'struct_': return new Struct$1(children || []);
        }
        switch (typeId) {
            case 'int': {
                const t = f['type'];
            ...
            case 'decimal': {
                const t = f['type'];
                return new Decimal$1(t['scale'], t['precision']);
            }
            case 'date': {
                const t = f['type'];
            ...
            case 'fixedsizelist': {
                const t = f['type'];
                return new FixedSizeList$1(t['listSize'], (children || [])[0]);
            }
            case 'map': {
                const t = f['type'];
                return new Map_$1((children || [])[0], t['keysSorted']);
            }
        }
    ...
    var Type = org$2.apache.arrow.flatbuf.Type;
    var _Field = org$2.apache.arrow.flatbuf.Field;
    var _Schema = org$2.apache.arrow.flatbuf.Schema;
    var _Buffer = org$2.apache.arrow.flatbuf.Buffer;
    var _Message = org$1.apache.arrow.flatbuf.Message;
    var _KeyValue = org$2.apache.arrow.flatbuf.KeyValue;
    var _FieldNode = org$1.apache.arrow.flatbuf.FieldNode;
    var _Endianness = org$2.apache.arrow.flatbuf.Endianness;
    var _RecordBatch = org$1.apache.arrow.flatbuf.RecordBatch;
    var _DictionaryBatch = org$1.apache.arrow.flatbuf.DictionaryBatch;
    /**
     * @ignore
     * @private
     **/
    ...
    function decodeMessageHeader(message, type) {
        return (() => {
            switch (type) {
                ...
                case MessageHeader.RecordBatch: return RecordBatch$1.decode(message.header(new _RecordBatch()), message.version());
    ...
    function decodeFieldType(f, children) {
        ...
        switch (typeId) {
            case Type.NONE: return new Null$1();
            case Type.Null: return new Null$1();
            case Type.Binary: return new Binary$1();
            case Type.Utf8: return new Utf8$1();
            case Type.Bool: return new Bool$1();
            case Type.List: return new List$1((children || [])[0]);
            case Type.Struct_: return new Struct$1(children || []);
        }
        switch (typeId) {
            case Type.Int: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Int());
                return new Int_(t.isSigned(), t.bitWidth());
            }
            case Type.FloatingPoint: {
                const t = f.type(new org$2.apache.arrow.flatbuf.FloatingPoint());
                return new Float(t.precision());
            }
            case Type.Decimal: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Decimal());
                return new Decimal$1(t.scale(), t.precision());
            }
            case Type.Date: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Date());
                return new Date_(t.unit());
            }
            case Type.Time: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Time());
                return new Time_(t.unit(), t.bitWidth());
            }
            case Type.Timestamp: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Timestamp());
                return new Timestamp_(t.unit(), t.timezone());
            }
            case Type.Interval: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Interval());
                return new Interval_(t.unit());
            }
            case Type.Union: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Union());
                return new Union_(t.mode(), t.typeIdsArray() || [], children || []);
            }
            case Type.FixedSizeBinary: {
                const t = f.type(new org$2.apache.arrow.flatbuf.FixedSizeBinary());
                return new FixedSizeBinary$1(t.byteWidth());
            }
            case Type.FixedSizeList: {
                const t = f.type(new org$2.apache.arrow.flatbuf.FixedSizeList());
                return new FixedSizeList$1(t.listSize(), (children || [])[0]);
            }
            case Type.Map: {
                const t = f.type(new org$2.apache.arrow.flatbuf.Map());
                return new Map_$1((children || [])[0], t.keysSorted());
            }
        }
    ...
    function encodeField(b, field) {
        ...
        if (!DataType.isDictionary(type)) {
            typeOffset = instance$8.visit(type, b);
        }
        else {
            typeId = type.dictionary.typeId;
            dictionaryOffset = instance$8.visit(type, b);
            typeOffset = instance$8.visit(type.dictionary, b);
        }
    ...
    class BaseVector extends AbstractVector {
        ...
        get VectorName() { return `${Type$1[this.typeId]}Vector`; }
        get ArrayType() { return this.type.ArrayType; }
    ...
    class BinaryVector extends BaseVector {
        asUtf8() {
            return AbstractVector.new(this.data.clone(new Utf8$1()));
        }
    }
    ...
    class BoolVector extends BaseVector {
        /** @nocollapse */
        static from(input) {
            return vectorFromValuesWithType(() => new Bool$1(), input);
        }
    }
    ...
    class FloatVector extends BaseVector {
        ...
        static from(input) {
            ...
            if ((input instanceof ArrayBuffer) || ArrayBuffer.isView(input)) {
                let InputType = arrayTypeToDataType$1(input.constructor) || ArrowType;
    ...
    class MapVector extends BaseVector {
        asList() {
            ...
            return AbstractVector.new(this.data.clone(new List$1(child)));
        }
        bind(index) {
    ...
    class Utf8Vector extends BaseVector {
        /** @nocollapse */
        static from(input) {
            return vectorFromValuesWithType(() => new Utf8$1(), input);
        }
        asBinary() {
            return AbstractVector.new(this.data.clone(new Binary$1()));
        }
    }
    ...
    /** @ignore */
    const instance$7 = new GetVisitor();
    ...
    function indexOfNull(vector, fromIndex) {
        ...
        let i = 0;
        for (const isValid of iterateBits(nullBitmap, vector.data.offset + (fromIndex || 0), vector.length, nullBitmap, getBool$1)) {
            if (!isValid) {
                return i;
            }
            ++i;
    ...
    /** @ignore */
    const instance$6 = new IndexOfVisitor();
    ...
    function nullableIterator(vector) {
        const getFn = instance$7.getVisitFn(vector);
    ...
    function vectorIterator(vector) {
        ...
        if (vector.stride === 1 && ((typeId === Type$1.Timestamp) ||
            (typeId === Type$1.Int && type.bitWidth !== 64) ||
            (typeId === Type$1.Time && type.bitWidth !== 64) ||
            (typeId === Type$1.Float && type.precision > 0 /* Precision.HALF */))) {
    ...
    /** @ignore */
    const instance$5 = new IteratorVisitor();
    ...
    function arrayOfVector(vector) {
        ...
        return [...instance$5.visit(vector)];
    }
    ...
    /** @ignore */
    const instance$4 = new ToArrayVisitor();
    ...
    /** @ignore */
    const instance$3 = new ByteWidthVisitor();
    ...
    /** @ignore */
    const instance$2 = new GetVectorConstructor();
    ...
    function newVector(data, ...args) {
        return new (instance$2.getVisitFn(data)())(data, ...args);
    }
    /** @ignore */
    ...
    Object.keys(Type$1)
        ...
        .filter((typeId) => typeId !== Type$1.NONE)
        .forEach((typeId) => {
        const VectorCtor = instance$2.visit(typeId);
        VectorCtor.prototype['get'] = partial1(instance$7.getVisitFn(typeId));
        VectorCtor.prototype['set'] = partial2(instance$a.getVisitFn(typeId));
        VectorCtor.prototype['indexOf'] = partial2(instance$6.getVisitFn(typeId));
        VectorCtor.prototype['toArray'] = partial0(instance$4.getVisitFn(typeId));
        VectorCtor.prototype['getByteWidth'] = partialType0(instance$3.getVisitFn(typeId));
        VectorCtor.prototype[Symbol.iterator] = partial0(instance$5.getVisitFn(typeId));
    });
    /** @ignore */
    ...
    class Table extends Chunked {
        constructor(...args) {
            ...
            super(new Struct$1(schema.fields), chunks);
            this._schema = schema;
            this._chunks = chunks;
        }
        /** @nocollapse */
    ...
    class RecordBatch extends StructVector {
        constructor(...args) {
            ...
            if (args[1] instanceof Data) {
                ...
                data = Data.Struct(new Struct$1(fields), 0, length, 0, null, childData);
            }
            super(data, children);
            this._schema = schema;
        }
    ...
    class DictionaryCollector extends Visitor {
        ...
        static collect(batch) {
            return new DictionaryCollector().visit(batch.data, new Struct$1(batch.schema.fields)).dictionaries;
        }
        visit(data, type) {
            if (DataType.isDictionary(type)) {
    ...
    /* src\streamlit\WithStreamlitConnection.svelte generated by Svelte v3.44.1 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*args*/ 8) switch_instance_changes.args = /*args*/ ctx[3];
    			if (dirty & /*disabled*/ 32) switch_instance_changes.disabled = /*disabled*/ ctx[5];
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const switch_instance_changes = (dirty & /*args, disabled, width*/ 56)
    			? get_spread_update(switch_instance_spread_levels, [
    					dirty & /*args*/ 8 && get_spread_object(/*args*/ ctx[3]),
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block = /*renderData*/ ctx[2] && create_if_block(ctx);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	validate_slots('WithStreamlitConnection', slots, []);
    	let { component } = $$props;
    	let { spreadArgs = true } = $$props;
     ...
     */
    	const onRenderEvent = event => {
    		...
    		$$invalidate(2, renderData = event.detail);

    		$$invalidate(3, args = renderData.args);
    		$$invalidate(5, disabled = renderData.disabled);
    	};
    	...
    	const writable_props = ['component', 'spreadArgs'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<WithStreamlitConnection> was created with unknown prop '${key}'`);
    	});

    	function onwindowresize() {
    		$$invalidate(4, width = window.innerWidth);
    	}

    	$$self.$$set = $$props => {
    		if ('component' in $$props) $$invalidate(0, component = $$props.component);
    		if ('spreadArgs' in $$props) $$invalidate(1, spreadArgs = $$props.spreadArgs);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ('component' in $$props) $$invalidate(0, component = $$props.component);
    		if ('spreadArgs' in $$props) $$invalidate(1, spreadArgs = $$props.spreadArgs);
    		if ('renderData' in $$props) $$invalidate(2, renderData = $$props.renderData);
    		if ('args' in $$props) $$invalidate(3, args = $$props.args);
    	...
    	return [component, spreadArgs, renderData, args, width, disabled, onwindowresize];
    }

    class WithStreamlitConnection extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { component: 0, spreadArgs: 1 });

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "WithStreamlitConnection",
    			options,
    			id: create_fragment$1.name
    		});
    		...
    		if (/*component*/ ctx[0] === undefined && !('component' in props)) {
    			console.warn("<WithStreamlitConnection> was created without expected prop 'component'");
    		}
    	}

    	get component() {
    		throw new Error("<WithStreamlitConnection>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set component(value) {
    		throw new Error("<WithStreamlitConnection>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src\ImageGallery.svelte generated by Svelte v3.44.1 */
    const file = "src\\ImageGallery.svelte";

    function add_css(target) {
    	append_styles(target, "svelte-1q3l3t1", ".scroller.svelte-1q3l3t1{min-height:100px;overflow-x:scroll;overflow-y:hidden;white-space:nowrap}img.svelte-1q3l3t1{display:inline-block;padding:1%;border-radius:20px;opacity:0.9;transition:all .2s}img.svelte-1q3l3t1:hover{opacity:1;transform:scale(1.05);cursor:pointer}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
    }
    ...
    // (14:2) {#each imageUrls as imageUrl}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "id", img_id_value = /*imageUrl*/ ctx[4]);
    			attr_dev(img, "alt", "");
    			set_style(img, "height", /*height*/ ctx[1] + "px");
    			attr_dev(img, "class", "svelte-1q3l3t1");
    			add_location(img, file, 14, 6, 389);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, img, anchor);

    			if (!mounted) {
    				dispose = listen_dev(img, "click", /*image_onclick*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*imageUrls*/ 1 && !src_url_equal(img.src, img_src_value = /*imageUrl*/ ctx[4])) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty & /*imageUrls*/ 1 && img_id_value !== (img_id_value = /*imageUrl*/ ctx[4])) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(14:2) {#each imageUrls as imageUrl}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	let div;
    	let each_value = /*imageUrls*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scroller svelte-1q3l3t1");
    			add_location(div, file, 12, 0, 328);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*imageUrls, height, image_onclick*/ 7) {
    				each_value = /*imageUrls*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['imageUrls', 'height'];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ImageGallery> was created with unknown prop '${key}'`);
    	});

    	$$self.$$set = $$props => {
    		if ('imageUrls' in $$props) $$invalidate(0, imageUrls = $$props.imageUrls);
    	...
    	$$self.$inject_state = $$props => {
    		if ('imageUrls' in $$props) $$invalidate(0, imageUrls = $$props.imageUrls);
    		if ('height' in $$props) $$invalidate(1, height = $$props.height);
    		if ('selectedImageUrl' in $$props) selectedImageUrl = $$props.selectedImageUrl;
    	};
    	...
    	return [imageUrls, height, image_onclick];
    }

    class ImageGallery extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { imageUrls: 0, height: 1 }, add_css);
    		...
    		if (/*imageUrls*/ ctx[0] === undefined && !('imageUrls' in props)) {
    			console.warn("<ImageGallery> was created without expected prop 'imageUrls'");
    		}

    		if (/*height*/ ctx[1] === undefined && !('height' in props)) {
    			console.warn("<ImageGallery> was created without expected prop 'height'");
    		}
    	}
